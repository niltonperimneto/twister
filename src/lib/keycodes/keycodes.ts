/* Vendored from the-via/app `src/utils/key.ts` (GPL-3.0).
 * Source: https://github.com/the-via/app
 * Keycode catalog + u16<->KC_* <->label helpers. Imports `@the-via/reader`
 * (our dependency) and the sibling `advanced-keys` module. */
...
import type { VIADefinitionV3, VIADefinitionV2 } from '@the-via/reader';
